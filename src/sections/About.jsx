    ...
    <>
      <section id="about-us" className="py-20">
        ...
        <p className="font-montserrat text-lg leading-8 mt-6 mb-10  text-center ">
          At AIKYAM Sports Science, we are passionate about advancing the world
          of sports science and technology to empower athletes to reach their
          full potential. With a mission deeply rooted in enhancing athlete
          performance, recovery, muscle strength, sports nutrition, and sports
          psychology, we are a cutting-edge sports technology company that
          leaves no stone unturned in achieving these goals.
        </p>
